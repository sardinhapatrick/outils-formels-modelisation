...
/*let p0 = model.places.first(where: {$0.name == "p0"}),
let p1 = model.places.first(where: {$0.name == "p1"}),
let p2 = model.places.first(where: {$0.name == "p2"}),
let p3 = model.places.first(where: {$0.name == "p3"}),
let p4 = model.places.first(where: {$0.name == "p4"}),
print("OK")*/
...
print("\n ======= Construction du Graphe de Couverture ======= \n")
